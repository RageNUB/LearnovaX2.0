    ...
    <main class="main-content">
        ...
        <div class="stats-grid" style="margin-bottom:24px;">
            ...
            <div class="stat-card blue">
                <div class="stat-icon">📋</div>
                <div class="stat-info">
                    <span class="stat-number"><?php echo count($enrollments); ?></span>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo $i + 1; ?></td>
                        <td>
                            <?php echo htmlspecialchars($e['student_name']); ?><br>
                            <small style="color:#6b7280;"><?php echo htmlspecialchars($e['student_email']); ?></small>
                        </td>

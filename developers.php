...
$team = [
    ...
    [
        'name'        => 'Sabbir Alam Alif',
        'id'          => '232-35-160',
        'role'        => 'Full Stack Developer',
        'avatar'      => 'dev2.png',
        'github'      => 'sabbiralamalif',
        'linkedin'    => 'sabbiralamalif',
        'badge'       => 'Phase 2',
        'badge_color' => 'blue',
    ...
    [
        'name'        => 'Taskin Tanisha Tahsin',
        'id'          => '232-35-391',
        'role'        => 'Frontend & Integration Developer',
        'avatar'      => 'dev3.png',
        'github'      => 'taskintanishatahsin',
        'linkedin'    => 'taskintanishatahsin',
        'badge'       => 'Phase 3',
        'badge_color' => 'green',
    ...
    [
        'name'        => 'Tasmim Jewel Joya',
        'id'          => '232-35-509',
        'role'        => 'UI/UX Designer & Frontend Developer',
        'avatar'      => 'dev4.png',
        'github'      => 'tasmimjeweljoya',
        'linkedin'    => 'tasmimjeweljoya',
        'badge'       => 'Phase 4',
        'badge_color' => 'orange',
...
$phases = [
    ['number'=>'01','title'=>'Authentication & Security','icon'=>'🔐','dev'=>'Jubaidul Islam Rimon', 'color'=>'#6c63ff','bg'=>'#ede9fe','items'=>['Database Design','User Registration','Login System','Role-Based Access','Session Management']],
    ['number'=>'02','title'=>'Course Management',        'icon'=>'📚','dev'=>'Sabbir Alam Alif',  'color'=>'#3b82f6','bg'=>'#dbeafe','items'=>['Course CRUD','Admin Approval','File Uploads','User Management','Dashboards']],
    ['number'=>'03','title'=>'Student Features',         'icon'=>'🎓','dev'=>'Taskin Tanisha Tahsin',    'color'=>'#10b981','bg'=>'#d1fae5','items'=>['Browse & Search','Shopping Cart','Checkout Flow','Reviews & Ratings','Profile Management']],
    ['number'=>'04','title'=>'Landing Page & UI',        'icon'=>'🎨','dev'=>'Tasmim Jewel Joya', 'color'=>'#f59e0b','bg'=>'#fef3c7','items'=>['Hero Section','Stats Counter','Course Showcase','Mobile Responsive','Animations']],
];
?>
<!DOCTYPE html>
<html lang="en">
